...
<a name="l36"><span class="ln">36   </span></a>      <span class="s4">const </span><span class="s3">generateRandomString = </span><span class="s4">function </span><span class="s3">(length</span><span class="s4">, </span><span class="s3">randomString = </span><span class="s5">''</span><span class="s3">) {</span>
<a name="l37"><span class="ln">37   </span></a>          <span class="s3">randomString += Math.random().toString(</span><span class="s7">20</span><span class="s3">).substr(</span><span class="s7">2</span><span class="s4">, </span><span class="s3">length)</span><span class="s4">;</span>
<a name="l38"><span class="ln">38   </span></a>          <span class="s4">if </span><span class="s3">(randomString.length &gt; length) </span><span class="s4">return </span><span class="s3">randomString.slice(</span><span class="s7">0</span><span class="s4">, </span><span class="s3">length)</span><span class="s4">;</span>
<a name="l39"><span class="ln">39   </span></a>          <span class="s4">return </span><span class="s3">generateRandomString(length</span><span class="s4">, </span><span class="s3">randomString)</span><span class="s4">;</span>
<a name="l40"><span class="ln">40   </span></a>        <span class="s3">}</span><span class="s4">,</span>
<a name="l41"><span class="ln">41   </span></a>        <span class="s3">strings = {</span>
<a name="l42"><span class="ln">42   </span></a>          <span class="s3">title: generateRandomString(</span><span class="s7">24</span><span class="s3">)</span><span class="s4">,</span>
<a name="l43"><span class="ln">43   </span></a>          <span class="s3">content: generateRandomString(</span><span class="s7">36</span><span class="s3">)</span><span class="s4">,</span>
<a name="l44"><span class="ln">44   </span></a>          <span class="s3">disagree: generateRandomString(</span><span class="s7">12</span><span class="s3">)</span>
<a name="l45"><span class="ln">45   </span></a>        <span class="s3">}</span>
<a name="l46"><span class="ln">46   </span></a>
<a name="l47"><span class="ln">47   </span></a>      <span class="s3">instance.popup.querySelectorAll(</span><span class="s5">'*[id]'</span><span class="s3">).forEach(el =&gt; {</span>
<a name="l48"><span class="ln">48   </span></a>        <span class="s3">el.textContent = strings[el.id] || el.textContent</span><span class="s4">;</span>
<a name="l49"><span class="ln">49   </span></a>      <span class="s3">})</span><span class="s4">;</span>
<a name="l50"><span class="ln">50   </span></a>    <span class="s3">}</span><span class="s4">,</span>
<a name="l51"><span class="ln">51   </span></a>    <span class="s3">appear: () =&gt; </span><span class="s4">true</span>
